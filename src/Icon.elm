...
styleWith :
    ...
    -> Style
styleWith { isActive, isTarget, error } =
    case ( isActive, isTarget, error ) of
        ( True, _, _ ) ->
            Active
